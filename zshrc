...
#POWERLEVEL9K_DIR_DEFAULT_BACKGROUND='cadetblue'
#
POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
POWERLEVEL9K_SHORTEN_DELIMITER=""
POWERLEVEL9K_SHORTEN_STRATEGY="truncate_from_right"

POWERLEVEL9K_DIR_HOME_BACKGROUND='darkseagreen4'
#POWERLEVEL9K_DIR_HOME_FOREGROUND='silver'
POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND='darkseagreen3'
POWERLEVEL9K_DIR_ETC_BACKGROUND='darkseagreen2'
POWERLEVEL9K_DIR_DEFAULT_BACKGROUND='darkseagreen1'
#POWERLEVEL9K_OS_ICON_BACKGROUND='silver'
#POWERLEVEL9K_OS_ICON_FOREGROUND='black'
POWERLEVEL9K_OS_ICON_BACKGROUND='silver'
POWERLEVEL9K_OS_ICON_FOREGROUND='orange3'
...
POWERLEVEL9K_VCS_CLEAN_FOREGROUND='springgreen4'
POWERLEVEL9K_VCS_CLEAN_BACKGROUND='honeydew2'
POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='yellow'
POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='honeydew2'
POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='red'
POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='honeydew2'
